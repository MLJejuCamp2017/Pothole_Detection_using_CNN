...
# xy = np.loadtxt("/Users/User/PycharmProjects/network/ML_Camp/Porthole_Detection/porthole/log.csv",unpack=True, delimiter=',', dtype=np.float32)
...
# x = np.loadtxt("/Users/User/PycharmProjects/network/ML_Camp/Porthole_Detection/porthole/log.csv", delimiter=',')
#
# np.reshape(x, (35,[]))
#
