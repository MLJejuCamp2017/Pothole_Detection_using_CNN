...
image_data = tf.gfile.FastGFile('/Users/User/PycharmProjects/network/ML_Camp/Porthole_Detection/speedbump_test.jpg', 'rb').read() # 수정됨, 경로 지정
...
with tf.Session() as sess:
    ...
    print(image_data) # image_data 의 모습 출력 >> 바이트 스트링으로 출력된다.
